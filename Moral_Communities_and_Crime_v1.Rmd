...
For the analysis, we use Principal Component Analysis, a data reduction technique, to obtain an indicator of Socio-Economic Deprivation. The loadings of the first factor, which accounts for almost 54% of the variance, are shown in Table \ref{tab:sed-descriptive-statistics}. The loadings of this factor indicate that high Socio-Economic Deprivation is a combination of (in terms of importance): high levels of poverty, high levels of unemployment, and low median income, followed by high levels of family disruption, in particular proportion of families led by young single mothers.
